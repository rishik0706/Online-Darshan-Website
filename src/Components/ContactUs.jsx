    ...
    <>
      ...
      <div className="row ">
        <div className="col-md-9 col-sm-12 ms-5 text-warning ">
          <div className=" ">
            <h1>
              Your Feedback are important, We would love to hear from you!
            </h1>
          </div>
        </div>
      </div>
      ...
      <hr />
      <div
        className="row justify-content-center fs-2 mt-5"
        style={{ background: "#fefbea" }}
      >
